<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeViewProfile.aspx.cs" Inherits="MileStone_3_Web.EmployeeViewProfile" %>
                ...
                <div class="collapse navbar-collapse" id="navbar" style="text-align:right;float:right;margin-left:auto;left:0">
                   <% if (Session["user"] != null) { %>
                        <div class="navbar-nav ms-auto mt-2">
                                <button id="EmpHome" onclick="location.href='EmployeeHome.aspx';" class="btn btn-dark">Home Page</button>
                    ...
                    <% } else { %>
                        <ul class="navbar-nav ms-auto mt-2">
                            ...
                            <li class="nav-item"><a class="nav-link" href="/Login.aspx">Log In</a></li>
                        </ul>
                     <% } %>
                </div>
            </div>
