<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeGradeDefence.aspx.cs" Inherits="MileStone_3_Web.EmployeeGradeDefence" %>
...
<body style="background-color:#35363a">
    ...
    <form id="form1" runat="server"  style="margin-left:100px">
        <h2 style="text-align:center;color:blue">Hello Employee You Can Grade Defence Here!</h2><br>
    <h4 style="color:red">Please fill in the following details to grade defence for a student</h4><br>
    ...
    <asp:TextBox ID="Defense_LocationBox" style="max-width:70%" placeholder="eg. M014" runat="server" required="true" class="form-control"></asp:TextBox><br>
    <asp:Label ID="Label5" runat="server" Text="Employee_Grade"></asp:Label>
    <asp:TextBox ID="Employee_GradeBox" style="max-width:70%" placeholder="eg. 22.2" runat="server" required="true" class="form-control"></asp:TextBox>
    <br />
    <br />
