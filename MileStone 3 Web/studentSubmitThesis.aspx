<%@ Page Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="studentSubmitThesis.aspx.cs" Inherits="MileStone_3_Web.studentSubmitThesis"  %>
...
<asp:Content ID="ContentPlaceHolder1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="form-group"; style="margin:100px">
      <asp:Panel ID="OK" runat="server" Visible="False">
       <asp:Label ID="Label2" ForeColor="#ffffff" visible="true" runat="server" Text="Submit thesis here."></asp:Label><br>
