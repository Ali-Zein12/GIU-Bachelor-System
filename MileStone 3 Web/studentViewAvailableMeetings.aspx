<%@ Page Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="studentViewAvailableMeetings.aspx.cs" Inherits="MileStone_3_Web.studentViewAvailableMeetings"  %>
...
<asp:Content ID="ContentPlaceHolder1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <h2>Available Meetings</h2><br><br> 
    
    
         <asp:Label ID="Label3" ForeColor="#ffffff" visible="true" runat="server"   Text=  "If there is no meeting records this means that all meetings have been booked or your lecturer hasn't made any meetings yet"></asp:Label>

    <table id ="table">
            <asp:Panel ID="Panel3" runat="server"></asp:Panel>
        </table>
       <h5 style="margin-left:90px;color:white">Ready to <a href="studentBookMeetings.aspx">book </a> a meeeting?</h5>
</asp:Content>
