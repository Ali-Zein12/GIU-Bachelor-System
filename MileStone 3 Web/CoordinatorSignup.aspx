<%@ Page Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="CoordinatorSignup.aspx.cs" Inherits="MileStone_3_Web.CoordinatorSignup"  %>

<asp:Content ID="ContentPlaceHolder1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 style="text-align:center;color:blue">Greetings Coordinator!</h2><br>
    ...
    <asp:TextBox ID="EMAIL" placeholder="eg. caroline.sabty@giu-uni.de" runat="server"  class="form-control"></asp:TextBox><br>
    ...
    <div class ="center">
        ...
        <asp:Label ID="LabelPass" Visible="false" runat="server" Text="Label"></asp:Label></div>
 </asp:Content>