    ...
    public partial class EEGradeDefense : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                EEGradeDefense.CommandType = CommandType.StoredProcedure;
                EEGradeDefense.Parameters.Add(new SqlParameter("@EE_id", c));
                EEGradeDefense.Parameters.Add(new SqlParameter("@sid", Convert.ToInt16(st_id)));
                EEGradeDefense.Parameters.Add(new SqlParameter("@defense_location", location));
                EEGradeDefense.Parameters.Add(new SqlParameter("@EE_grade", Convert.ToInt16(grade)));
                ...
                using (SqlConnection conn2 = new SqlConnection(connStr2))
                {
                    ...
                    if (result != null && result != DBNull.Value)
                    {
                        ...
                        if (output != 1)
                        {
                            Label1.Text = "This student doesn't have a defense";
                        }
                        else
                        {
                            conn.Open();
                            EEGradeDefense.ExecuteNonQuery();
                            conn.Close();
                            Label1.Text = "Defense grade updated successfuly!";
                        }
                        Label1.Visible = true;
                    }
                    conn2.Close();
