<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeGradeThesis.aspx.cs" Inherits="MileStone_3_Web.EmployeeGradeThesis" %>
...
<body style="background-color:#35363a">
    ...
    <form id="form1" runat="server"  style="margin:70px">
        <h2 style="text-align:center;color:blue">Hello Employee You Can Grade Thesis Here!</h2><br>
    <h4 style="color:red">Please fill in the following details to Grade Thesis for a Student</h4><br>
    ...
    <br>
    <asp:Label ID="Label5" runat="server" ForeColor="White" Text="Employee_Grade"></asp:Label>
    <asp:TextBox ID="Employee_GradeBox" style="max-width:70%" placeholder="eg. 24.52" runat="server" required="true" class="form-control"></asp:TextBox>
    <br />
    <br />
